...
const DEMO_IMAGES: ImageItem[] = [
  { id: '1', name: 'fz01.jpg', src: 'img/fz01.jpg', width: 800, height: 600, size: '84 KB'  },
  { id: '2', name: 'fz02.jpg', src: 'img/fz02.jpg', width: 800, height: 600, size: '121 KB' },
  { id: '3', name: 'fz03.jpg', src: 'img/fz03.jpg', width: 800, height: 600, size: '163 KB' },
  { id: '4', name: 'fz04.jpg', src: 'img/fz04.jpg', width: 800, height: 600, size: '190 KB' },
  { id: '5', name: 'fz05.jpg', src: 'img/fz05.jpg', width: 800, height: 600, size: '90 KB'  },
  { id: '6', name: 'fz06.jpg', src: 'img/fz06.jpg', width: 800, height: 600, size: '119 KB' }
]
...
export default function ImageViewer() {
  ...
  useEffect(() => {
    if (isSlideshow) {
      slideshowTimer.current = setInterval(goNext, 3000);
    } else {
  ...
  useEffect(() => {
    if (showThumbnails && thumbnailContainerRef.current) {
      const button = thumbnailContainerRef.current.children[currentIndex] as HTMLElement;
      if (button) {
  ...
  return (
    <div className="flex flex-col h-full relative" style={{ background: '#0A0A0A' }}>
      ...
      {showThumbnails && !isSlideshow && (
        ...
        >
          <div ref={thumbnailContainerRef} className="flex gap-2 p-2">
            {images.map((img, i) => (
              <button
                key={img.id}
