        ...
        <div className="flex items-center gap-0 border-b overflow-x-auto custom-scrollbar" style={{ borderColor: 'var(--border-subtle)', background: 'var(--bg-titlebar)' }}>
          {files.map(f => (
            <div
              ...
              className="flex items-center gap-1.5 px-3 py-1.5 text-xs border-r min-w-0 shrink-0 transition-colors cursor-pointer"
              style={{
            ...
            >
              ...
              <span
                ...
                className="ml-1 hover:text-[var(--accent-error)] flex items-center justify-center"
                role="button"
