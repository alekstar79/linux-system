...
const AppLauncher = memo(function AppLauncher() {
  ...
  return (
    ...
    >
      {/* Search bar */}
      <div
        className="relative w-[480px] max-w-[90vw] flex-shrink-0"
        style={{
      ...
      {!searchQuery && frequentApps.length > 0 && (
        <div className="mt-6 w-[480px] max-w-[90vw] flex-shrink-0"
      ...
      {!searchQuery && (
        <div
          className="flex items-center gap-0 mt-6 overflow-x-auto max-w-[90vw] flex-shrink-0"
      ...
      {/* App grid */}
      <div
        className="mt-6 w-[720px] max-w-[90vw] overflow-y-auto flex-1 pb-8"
        style={{
          display: 'grid',
